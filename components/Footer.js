    ...
    <div className="bg-gray-950 px-7 py-5 space-y-5">
      <div className="flex justify-between">
        <div className="text-white flex flex-col space-y-4">
          <h1 className="text-lg font-bold font-sans tracking-wider">NEWSHUB</h1>
      ...
      <div className="text-white text-center text-sm">
        © 2024 NEWSHUB, LLC. All Rights Reserved. Use of this site constitutes
        acceptance of our Terms of Service, Privacy Policy and Do Not Sell or
        Share My Personal Information. NEWSHUB may receive compensation for some
